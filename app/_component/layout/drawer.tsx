            ...
            <ul>
              {menuItems.map((menuitem) => (
                <li key={menuitem.id}>
                  ...
                  <Link
                    href={menuitem.href}
                    className={`text-neutral text-3xl  flex justify-center gap-x-1  hover:bg-neutral hover:text-info rounded-md mt-4 ${
                      open && "hidden"
                    }`}
                  >
                  ...
                  <Link
                    href={menuitem.href}
                    className={`text-neutral text-xl  flex gap-x-1 cursor-point p-4 px-5 hover:bg-neutral hover:text-info  rounded-md mt-4" ${
                      !open && "hidden"
                    }`}
                  >
                    {menuitem.icon ? menuitem.icon : <AiFillHome />}
